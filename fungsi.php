...
// NILAI BOBOT KRITERIA UNTUK PERHITUNGAN ALTERNATIF
...
// hapus alternatif
function deleteAlternatif($id_alternatif) {
	include('config.php');
	...
	$query 	= "DELETE FROM ranking WHERE id_alternatif=$id_alternatif";
	mysqli_query($koneksi, $query);

	$query 	= "DELETE FROM perbandingan_alternatif WHERE alternatif1=$id_alternatif OR alternatif2=$id_alternatif";
	mysqli_query($koneksi, $query);
}
