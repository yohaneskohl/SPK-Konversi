                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="buttons card-header-icon">
                                <a class="button is-link" href="hitung_alternatif.php">
                        ...
                        <div class="card-content">
                            <form action="" method="post">
                                        ...
                                        <div class="select">
                                            <select name="id_les">
                                                <?php foreach ($alternatif as $row): ?>
                                                    <option value="<?= $row["id_alternatif"] ?>" <?php if ($data["id_alternatif"] == $row["id_alternatif"]): ?>
                                        ...
                                        <div class="select">
                                            <select name="id_kriteria">
                                                <?php foreach ($kriteria as $row): ?>
                                                    <option value="<?= $row["id_kriteria"] ?>" <?php if ($data["id_kriteria"] == $row["id_kriteria"]): ?> selected="selected"
                                                        <?php endif; ?>>
                                                        <?= $row["nm_kriteria"] ?>
                                                    </option>
                                                <?php endforeach ?>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input type="hidden" value="<?= $data["id_nilai"]; ?>" name="id">
                                        <input class="input" type="text" placeholder="Nilai untuk setiap alternatif"
