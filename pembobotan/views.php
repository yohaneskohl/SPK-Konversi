                    ...
                    <div class="card animate__animated animate__zoomIn">
                        <div class="card-header">
                            ...
                            <div class="buttons card-header-icon">
                                <a class="button is-link" href="add.php">
                                ...
                                <table class="table is-fullwidth">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $row) : ?>
                                            ...
                                            <td>
                                                <div class="buttons">
                                                    <a class="button is-link" href="hitung_alternatif.php&id=<?= $row['id_nilai']; ?>">
    ...
    function archiveFunction() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "hitung_alternatif.php?halaman=hapusdatabobot&id=<?= $row['id_nilai']; ?>";
            }
        })
    }
</script>